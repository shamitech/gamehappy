...
(function (root, factory) {
  ...
  dust.isStreamable = function (elem) {
    return (
      elem && typeof elem.on === "function" && typeof elem.pipe === "function"
    );
  };
  ...
  Stream.prototype.on = function (type, callback) {
    ...
    if (typeof callback !== "function") {
      dust.log(
        "No callback function provided for `" + type + "` event listener",
        WARN,
      );
    } else {
      ...
      stream
        ...
        .on("error", function error(err) {
          ...
          if (errorBody) {
            ...
            dust.log(
              "Unhandled stream error in `" + context.getTemplateName() + "`",
              INFO,
            );
          }
          if (!ended) {
...
var DocmaWeb = (function () {
  ...
  Utils.getParent = function (docs, symbol) {
    var sym =
      typeof symbol === "string" ? Utils.getSymbolByName(docs, symbol) : symbol;
    if (!sym) return null;
  ...
  function getFormatValue(symbol, val) {
    if (arguments.length < 2) {
      val =
        DocmaWeb.Utils.notate(symbol, "meta.code.value") || symbol.defaultvalue;
    }
        ...
        documentation: [
          {
            ...
            meta: {
              ...
              lineno: 24,
              columnno: 2,
              path: "/home/jpietal/projects/uwebsockets.js/dist",
              code: {},
            },
            kind: "typedef",
            name: "TemplatedApp",
            type: { names: ["uws.js:SSLApp", "uws.js:App"] },
            description:
              "TemplatedApp is either an SSL or non-SSL app. See App for more info, read user manual.",
            properties: [
              {
                type: { names: ["function"] },
                description:
                  "(host: RecognizedString, port: number, cb: (listenSocket: us_listen_socket) => void): TemplatedApp;\nListens to hostname & port. Callback hands either false or a listen socket.",
                name: "listen",
              },
              {
                type: { names: ["function"] },
                description:
                  "(port: number, cb: (listenSocket: any) => void): TemplatedApp;\nListens to port. Callback hands either false or a listen socket.",
                name: "listen",
              },
              {
                type: { names: ["function"] },
                description:
                  "(pattern: RecognizedString, handler: (res: HttpResponse, req: HttpRequest) => void) : TemplatedApp;\nRegisters an HTTP GET handler matching specified URL pattern.",
                name: "get",
              },
              {
                type: { names: ["function"] },
              ...
              },
              {
                type: { names: ["function"] },
                description:
                  "(pattern: RecognizedString, behavior: WebSocketBehavior) : TemplatedApp;\nRegisters a handler matching specified URL pattern where WebSocket upgrade requests are caught.",
                name: "ws",
              },
              {
                type: { names: ["function"] },
                description:
                  "(topic: RecognizedString, message: RecognizedString, isBinary?: boolean, compress?: boolean) : TemplatedApp;\nPublishes a message under topic, for all WebSockets under this app. See WebSocket.publish.",
                name: "publish",
              },
            ],
            longname: "TemplatedApp",
            scope: "global",
            $longname: "TemplatedApp",
            $kind: "typedef",
            $docmaLink: "api/#TemplatedApp",
          },
        ],
        symbols: ["TemplatedApp"],
      },
    },
    app: {
      title: "µWebSockets.js Documentation",
      meta: null,
      base: "./",
        ...
        navbar: {
          ...
          menu: [
            ...
            },
            {
              ...
              items: [
                {
                  label: "<code>yarn add uwebsockets.js -D</code>",
                  href: "https://www.npmjs.com/package/uwebsockets.js",
                  target: "_blank",
                },
                {
                  label: "µWebSockets.js Releases",
                  href: "https://github.com/Prozi/uwebsockets.js/releases",
                  target: "_blank",
                },
                { separator: true },
            ...
            },
            {
              ...
              label: "",
              href: "https://github.com/Prozi/uwebsockets.js",
              target: "_blank",
            },
          ],
        },
