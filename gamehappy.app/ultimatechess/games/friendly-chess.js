...
class FriendlyChessGame {
    ...
    renderBoard() {
        ...
        const pieceSVGs = {
            'rook': '<svg viewBox="0 0 100 100"><path d="M25,85 L25,40 L30,40 L30,25 L35,25 L35,40 L40,40 L40,20 L50,20 L50,40 L60,40 L60,20 L70,20 L70,40 L75,40 L75,25 L80,25 L80,40 L85,40 L85,85 Z M35,50 L65,50 L65,80 L35,80 Z" fill="currentColor" stroke="currentColor" stroke-width="0.5"/></svg>',
            'knight': '<svg viewBox="0 0 100 100"><path d="M30,85 L30,65 L35,60 L38,60 L40,55 L42,55 L45,50 L50,48 L55,50 L58,52 L60,50 L65,55 L70,60 L75,60 L80,70 L80,85 Z M35,70 L65,70 L65,85 L35,85 Z" fill="currentColor" stroke="currentColor" stroke-width="0.5"/></svg>',
            'bishop': '<svg viewBox="0 0 100 100"><circle cx="50" cy="28" r="6" fill="currentColor" stroke="currentColor" stroke-width="0.5"/><path d="M48,35 L45,45 L48,50 L52,50 L55,45 L52,35 Z" fill="currentColor" stroke="currentColor" stroke-width="0.5"/><path d="M45,50 L55,50 L60,65 L58,80 L42,80 L40,65 Z" fill="currentColor" stroke="currentColor" stroke-width="0.5"/><circle cx="50" cy="40" r="1.5" fill="currentColor"/></svg>',
            'queen': '<svg viewBox="0 0 100 100"><circle cx="50" cy="25" r="5" fill="currentColor" stroke="currentColor" stroke-width="0.5"/><circle cx="35" cy="32" r="3" fill="currentColor"/><circle cx="50" cy="30" r="3" fill="currentColor"/><circle cx="65" cy="32" r="3" fill="currentColor"/><path d="M32,40 L38,50 L42,48 L50,58 L58,48 L62,50 L68,40 L68,85 L32,85 Z" fill="currentColor" stroke="currentColor" stroke-width="0.5"/></svg>',
            'king': '<svg viewBox="0 0 100 100"><rect x="48" y="18" width="4" height="10" fill="currentColor"/><circle cx="50" cy="25" r="4" fill="currentColor"/><rect x="46" y="22" width="2" height="6" fill="currentColor"/><rect x="52" y="22" width="2" height="6" fill="currentColor"/><path d="M38,35 L42,45 L45,50 L55,50 L58,45 L62,35 L62,85 L38,85 Z" fill="currentColor" stroke="currentColor" stroke-width="0.5"/></svg>',
            'pawn': '<svg viewBox="0 0 100 100"><circle cx="50" cy="28" r="6" fill="currentColor" stroke="currentColor" stroke-width="0.5"/><ellipse cx="50" cy="40" rx="8" ry="5" fill="currentColor" stroke="currentColor" stroke-width="0.5"/><path d="M44,46 L44,75 L56,75 L56,46 Z" fill="currentColor" stroke="currentColor" stroke-width="0.5"/><path d="M40,75 L60,75 L60,85 L40,85 Z" fill="currentColor" stroke="currentColor" stroke-width="0.5"/></svg>'
        };
